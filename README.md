...
Building frontend web
Founder/Software Engineer @ Klink

Leads a team of six to build a platform designed to help small influencers connect, collaborate, and expand their online presence, currently supporting a community of 300+ users.
...
Implemented automated testing using Cypress for end-to-end testing and Jest for unit testing, ensuring robust application functionality, reducing bugs, and improving code reliability.
